  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-white px-4 py-24 md:px-8">
      <div className="mx-auto flex max-w-4xl flex-col items-center justify-center text-center">
        ...
        <div className="mb-12">
          <TextReveal blockColor="#ff4d00" animateOnScroll={true} delay={0.2}>
            <h2 className="font-pp-neue-montreal mb-4 text-2xl text-black md:text-3xl lg:text-4xl">
              Page Not Found
            </h2>
          </TextReveal>
        </div>
        ...
        <div className="mb-12 max-w-2xl">
          <TextReveal blockColor="#ff4d00" animateOnScroll={true} delay={0.4}>
