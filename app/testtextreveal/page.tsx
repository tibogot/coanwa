      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="h-screen flex items-center justify-center px-8">
          <div className="text-center">
            <TextReveal animateOnScroll={false} blockColor="#000" delay={0.3}>
              <h1 className="text-7xl md:text-8xl lg:text-9xl font-black text-gray-900 leading-tight">
                Beautiful Text
                <br />
                Reveal Animation
              </h1>
          ...
          <div className="text-center max-w-5xl mx-auto w-full">
            <TextReveal animateOnScroll={true} blockColor="#10b981" delay={0.2}>
              <div className="mx-auto text-center">
                <h2 className="text-5xl md:text-6xl font-semibold text-gray-900 mb-8 text-center">
          ...
          <div className="text-center max-w-5xl mx-auto w-full">
            ...
            >
              <div className="space-y-8 mx-auto text-center">
                <h3 className="text-4xl md:text-5xl font-bold text-gray-900 text-center">
                  Multiple Elements
                </h3>
                <p className="text-2xl md:text-3xl text-gray-700 font-light text-center">
        ...
        <section className="py-32 px-8 flex items-center justify-center">
          <div className="text-center max-w-5xl mx-auto w-full">
            ...
            >
              <div className="mx-auto text-center">
                <p className="text-4xl md:text-5xl font-light text-gray-800 text-center">
          ...
          <div className="text-center max-w-5xl mx-auto w-full">
            <TextReveal blockColor="#f59e0b" duration={1} stagger={0.15}>
              <div className="bg-gray-900 p-12 md:p-16 rounded-3xl mx-auto text-center">
                <h2 className="text-5xl md:text-6xl font-black text-white text-center">
                  Works With Any Styling
                </h2>
                <p className="text-2xl md:text-3xl text-gray-300 font-light mt-6 text-center">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-8 w-full max-w-6xl mx-auto">
              <TextReveal blockColor="#ffffff" duration={0.9} stagger={0.2}>
                <div className="mx-auto text-center">
                  <h2 className="text-6xl md:text-8xl font-black text-white text-center">
                    Text Over Image
                  </h2>
                  <p className="text-2xl md:text-3xl text-white/90 font-light mt-6 text-center">
