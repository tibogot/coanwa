...
export default function Footer() {
  return (
    <footer className="relative flex h-screen w-full flex-col bg-black text-white">
      <div className="mx-auto flex h-full w-full max-w-7xl flex-col justify-between px-8 py-16 md:px-12 lg:px-16">
        {/* Top Section */}
        <div className="flex flex-col gap-12 lg:flex-row lg:justify-between lg:gap-16">
          ...
          <div className="flex flex-col gap-6 lg:max-w-md">
            ...
            <p className="font-pp-neue-montreal text-lg leading-relaxed text-white/80">
              A leading construction company offering integrated solutions in
              Civil, Electrical, and Mechanical Engineering with 34+ years of
              excellence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-12 md:grid-cols-3 lg:gap-16">
            <div className="flex flex-col gap-4">
              <h3 className="font-pp-neue-montreal text-sm font-semibold tracking-wider text-white/60 uppercase">
                Company
              </h3>
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li className="mt-2 text-white/60">
